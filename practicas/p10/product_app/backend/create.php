<?php
    ...
    if (!empty($producto)) {
        ...
        if ($result_check->num_rows > 0) {
            ...
            $query_insert = "INSERT INTO productos (nombre, precio, unidades, modelo, marca, detalles, imagenes, eliminado) 
                            VALUES ('$nombre', '$precio', '$unidades', '$modelo', '$marca', '$detalles', '$imagenes', 0)";
